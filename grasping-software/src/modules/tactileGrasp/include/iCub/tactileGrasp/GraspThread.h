    ...
    namespace tactileGrasp {
        ...
        class GraspThread : public yarp::os::RateThread {
            private:
				...
				int sampleCounter;
				double refVoltage;
				int operationMode; // 0: normal | 1: convergency | 2: interpolation | 3: go back smoothly | 4: vel control mode | 5: convergency modified | 6: vel control mode modified | 7 full control mode | -1: do nothing
				...
				std::vector<double> pwmAndTFVector;
				...
				int op7Contr4State; // control state 4, 0 descent , 1 stabilization
				int op7RampCounter;
