...
#ifndef YARP_THRIFT_GENERATOR_plantIdentification_IDLServer
#define YARP_THRIFT_GENERATOR_plantIdentification_IDLServer

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>

class plantIdentification_IDLServer;


/**
 * plantIdentification_IDLServer
 * IDL Interface to \ref plantIdentification services.
 */
class plantIdentification_IDLServer : public yarp::os::Wire {
public:
  plantIdentification_IDLServer();
  /**
